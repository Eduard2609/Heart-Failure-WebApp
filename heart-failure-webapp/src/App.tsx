...
import { predictHeartDisease } from "./utils/api/ApiConnect";
...
const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
  ...
  ].flat().filter((value) => value !== null) as number[];;
  ...
  predictHeartDisease(convertedData)
  .then((message) => setResultMessage(message));
